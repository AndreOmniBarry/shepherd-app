...
const ROLE_SECTIONS: Record<string, Section[]> = {
  ...
  lead_tech: [{ heading: 'Platform administration', body: 'Your account has cross-church platform access for support purposes. This is a materially higher trust level than any church-side role — it is logged, and is for legitimate support/maintenance only, never for viewing a church\'s data out of curiosity.' }],
