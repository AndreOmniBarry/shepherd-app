...
const JWT_SECRET = new TextEncoder().encode(process.env.JWT_SECRET || "shepherd-dev-secret-change-in-production-minimum-32-chars");
const PUBLIC_PATHS = [
    "/login",
    "/register",
    "/setup",
